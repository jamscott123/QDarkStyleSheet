...
def get_main_window_app(qt_from='pyqt', no_dark=True):
    ...
    if qt_from == 'pyside':
        ...
        # getting style
        style = jam_darkstyle.load_stylesheet_pyside()
        ...
        # getting style
        style = jam_darkstyle.load_stylesheet_pyqt()
        ...
        # getting style
        style = jam_darkstyle.load_stylesheet_pyqt5()
        ...
        # getting style
        style = jam_darkstyle.load_stylesheet_from_environment()

    elif qt_from == 'pyqtgraph':
        # using PyQtGraph API
        from pyqtgraph.Qt import QtGui, QtCore
        # getting style
        style = jam_darkstyle.load_stylesheet_from_environment(is_pyqtgraph=True)
    ...
    # create main window
    window = QMainWindow()
    window.setWindowTitle("QDarkStyle v." + jam_darkstyle.__version__ +
                          " - TEST - Using " + qt_from)
